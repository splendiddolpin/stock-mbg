    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-blue-500">
                <form action="{{ route('daily-menus.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    @csrf
                    
                    <div class="w-full">
                        <label class="block text-sm font-bold mb-2 text-gray-700">📅 Tanggal Sajian</label>
                        <input type="date" name="date" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value="{{ date('Y-m-d') }}" required>
                    </div>
                ...
                <p class="mt-3 text-xs text-gray-500 italic font-medium">* Ahli Gizi bisa memasukkan lebih dari satu menu pada tanggal yang sama dengan target yang berbeda.</p>
            </div>

            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                    <h3 class="font-bold text-gray-700 flex items-center gap-2">
                        <span>📅</span> Daftar Jadwal Masak & Target
                    </h3>
                                ...
                                <tr>
                                    <td colspan="4" class="py-12 text-center text-gray-500 bg-gray-50/50">
                                        <div class="flex flex-col items-center gap-2">
                                            ...
                                            <p class="font-bold text-gray-400">Belum ada jadwal menu yang dibuat.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
