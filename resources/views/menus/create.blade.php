<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8"> <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('menus.store') }}" method="POST">
                    ...
                    <div x-data="{ 
                            ingredients: [
                                { id: Date.now(), item_id: '', gramasi_besar: '', gramasi_kecil: '', gramasi_balita: '', gramasi_bumil: '' }
                            ] 
                        }" class="mb-6">
                        ...
                        <div x-show="ingredients.length === 0" class="text-center py-4 text-gray-500 italic text-sm border-2 border-dashed border-gray-200 rounded">
                            Belum ada bahan yang ditambahkan. Klik tombol "+ Tambah Baris Bahan" di atas.
                        </div>
                    ...
                    <div class="flex items-center justify-end mt-6 gap-4 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow transition">Simpan Menu & Resep</button>
                    </div>
