                ...
                <form action="{{ route('menus.update', $menu->id) }}" method="POST">
                    ...
                    <div x-data="{ 
                        ...
                        <template x-for="(ing, index) in ingredients" :key="ing.id">
                            <div class="grid grid-cols-12 gap-3 mb-3 items-center bg-gray-50 p-2.5 rounded-lg border border-gray-200 relative hover:bg-white transition-colors shadow-sm">
                        ...
                        <div x-show="ingredients.length === 0" class="text-center py-6 text-gray-500 bg-gray-50 italic text-sm border-2 border-dashed border-gray-300 rounded-lg">
                            Resep masih kosong.<br>Klik tombol <strong>"+ Tambah Baris Bahan"</strong> untuk menyusun komposisi.
                        </div>
                    ...
                    <div class="flex items-center justify-end mt-6 gap-4 pt-5 border-t border-gray-200">
                        ...
                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 px-8 rounded-lg shadow-md transition transform active:scale-95">Update Menu & Resep</button>
                    </div>
